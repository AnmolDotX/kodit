...
function EditorComponent({socketRef,roomId,onCodeChange}) {
    ...
    return <CodeMirror className='text-lg border border-black'  value={value} height="60vh" theme={tokyoNightStorm} extensions={[javascript({ jsx: true }), python(), java(), cpp()]} onChange={onChange} />;
}
